...
export default async function Layout({
  ...
  const { id: courseId } = await params;
  const {t} = await getT(["course", "dashboard"]);
  ...
  try {
    ...
    const breadcrumbs = [
      { label: t("common:courses"), href: "/dashboard/student/courses" },
      { label: truncate(initialCourseData.title, 30) || "...", href: "#" }, 
    ];

    return (
      <CoursePublicDetailProvider initialCourse={initialCourseData as any}>  
        <DashboardContent breadcrumbs={breadcrumbs} contentClassName="p-0 gap-0">
          <Separator />
          ...
          <div className="flex flex-col lg:flex-row flex-1">
            ...
            <div className="lg:w-80 lg:sticky lg:top-4 lg:self-start h-full">
