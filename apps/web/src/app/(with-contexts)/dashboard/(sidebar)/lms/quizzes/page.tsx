...
export default function Page() {
  ...
  const handleArchive = useCallback(
    (quiz: ItemType) => {
      if (confirm(t("dashboard:lms.quizzes.archive_confirm"))) {
    ...
    return [
        ...
        cell: ({ row }) => {
          ...
          return (
            <Badge variant="outline">
              {course?.title || quiz.courseId || t("dashboard:table.no_course")}
            </Badge>
          );
        },
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="text-sm text-muted-foreground">
              {owner?.name || owner?.email || quiz.ownerId || t("common:unknown")}
            </div>
          );
        },
      },
      {
        ...
        header: t("dashboard:table.questions"),
        cell: ({ row }) => {
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon">
                  ...
                  <span className="sr-only">{t("dashboard:lms.quizzes.actions.open_menu")}</span>
                </Button>
              </DropdownMenuTrigger>
    ...
    <DashboardContent breadcrumbs={breadcrumbs}>
      <HeaderTopbar
        header={{
          ...
          subtitle: t("dashboard:lms.quizzes.module_description"),
        }}
