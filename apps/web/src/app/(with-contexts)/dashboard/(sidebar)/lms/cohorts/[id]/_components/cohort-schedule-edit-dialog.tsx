...
export function CohortScheduleEditDialog({ control, onSuccess }: CohortScheduleEditDialogProps) {
  ...
  const createMutation = trpc.lmsModule.schedule.create.useMutation({
    onSuccess: () => {
      toast({ title: t("common:success"), description: t("common:toast.item_created_successfully", { item: t("common:schedule_event") }) });
      onSuccess?.();
      handleClose();
    },
    onError: (err) => {
  ...
  const updateMutation = trpc.lmsModule.schedule.update.useMutation({
    onSuccess: () => {
      toast({ title: t("common:success"), description: t("common:toast.item_updated_successfully", { item: t("common:schedule_event") }) });
      onSuccess?.();
      handleClose();
    },
    onError: (err) => {
...
const deleteMutation = trpc.lmsModule.schedule.delete.useMutation({
    onSuccess: () => {
        toast({ title: t("common:success"), description: t("common:toast.item_deleted_successfully", { item: t("common:schedule_event") }) });
        onSuccess?.();
        handleClose();
    },
    onError: (err) => {
