...
export default function Page() {
    ...
    const breadcrumbs = useMemo(() => [{ label: t("dashboard:lms.cohort.module_title"), href: "#" }], [t]); 
    ...
    const deleteMutation = trpc.lmsModule.cohortModule.cohort.delete.useMutation({
        onSuccess: () => {
            toast({ title: t("common:success"), description: "Cohort deleted successfully" });
        ...
        >
            <HeaderTopbar
                header={{
                    ...
                    subtitle: t("dashboard:lms.cohort.module_description"),
                }}
                rightAction={
                    <CreateButton onClick={handleCreateCohort} />
                }
            />
