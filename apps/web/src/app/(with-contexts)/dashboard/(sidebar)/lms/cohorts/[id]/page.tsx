...
import { Calendar, Save, Plus, Users, Video } from "lucide-react";
            ...
            <HeaderTopbar
                ...
                rightAction={
                    <div className="flex gap-2">
                        ...
                        <Link href={`/dashboard/lms/live-classes?filters[cohortId]=${cohortId}`}>
                            <Button variant="outline">
                                <Video className="h-4 w-4 mr-2" />
                                {t("dashboard:lms.live_classes.module_title")}
                            </Button>
                        </Link>
                                            ...
                                            renderLabel={(item) => (
                                                <UserAvatarLabel 
                                                    user={{ 
                                                        ...
                                                        avatar: item.avatarUrl ? { url: item.avatarUrl } : undefined
                                                    }} 
                                                    showEmail={false} 
                                                />
                                            )}
