...
import { DataTableToolbar, DeleteConfirmNiceDialog, NiceModal, useDataTable, useToast } from "@workspace/components-library";
...
export default function Page() {
    ...
    const breadcrumbs = useMemo(() => [
        { label: t("dashboard:lms.cohort.module_title"), href: "/dashboard/lms/cohorts" },
        { label: cohort?.title || t("common:edit"), href: `/dashboard/lms/cohorts/${cohortId}` },
    ...
    return (
        ...
        >
            <HeaderTopbar
                header={{
                    title: cohort?.title || t("common:title"),
