  ...
  const handleUploadAttachment = useCallback(
    async (files: File[], _type: string, _storageProvider?: string, _caption?: string): Promise<any[]> => {
      if (!loadDetailQuery.data?._id) {
        toast({
          title: t("common:error"),
          description: t("common:toast.item_save_before_upload", { item: "assignment" }),
          variant: "destructive",
        });
      ...
      if (result.success && result.media) {
        ...
        toast({
          title: t("common:success"),
          description: t("common:toast.item_uploaded_successfully", { item: "Attachment" }),
        });
        return [result.media];
      } else {
        toast({
          title: t("common:error"),
          description: result.error || t("common:toast.item_upload_error", { item: "attachment" }),
          variant: "destructive",
        });
  ...
  const handleRemoveAttachment = useCallback(
    async (mediaId: string) => {
      if (!loadDetailQuery.data?._id) {
        toast({
          title: t("common:error"),
          description: t("common:toast.item_not_found", { item: "Assignment" }),
          variant: "destructive",
        });
      ...
      if (result.success) {
        ...
        toast({
          title: t("common:success"),
          description: t("common:toast.item_removed_successfully", { item: "Attachment" }),
        });
      } else {
        toast({
          title: t("common:error"),
          description: result.error || t("common:toast.item_remove_error", { item: "attachment" }),
          variant: "destructive",
        });
