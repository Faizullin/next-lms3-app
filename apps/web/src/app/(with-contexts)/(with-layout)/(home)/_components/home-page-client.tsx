...
export default function HomePageClient({ websiteSettings }: HomePageClientProps) {
  ...
  const stats = [
    { number: "10+", label: t("frontend:home.stats_years_experience") },
    { number: "200+", label: t("frontend:home.stats_students_enrolled") },
    { number: "40+", label: t("frontend:home.stats_popular_courses") }, 
    { number: "40+", label: t("frontend:home.stats_ai_powered_courses") },
  ];
                        ...
                        <div className="p-4 space-y-2">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                              {t("frontend:home.courses_provider")}
                            </p>
                          </div>
                          ...
                          <div className="flex items-center justify-between pt-2">
                            ...
                            <span className="text-xs text-muted-foreground">
                              {
                                t("frontend:home.courses_students_count", { count: course.students })
                              }
                            </span>
                          </div>
                        </div>
