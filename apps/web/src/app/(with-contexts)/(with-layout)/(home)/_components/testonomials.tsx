...
export function TestimonialsSection(props: {
  ...
  const testimonials = useMemo(() => {
    const defaultData = [
      {
        quote: t("frontend:home.testimonials_1_quote"),
        author: {
          userId: "Aigerim K.",
          name: "Aigerim K.",
      ...
      {
        quote: t("frontend:home.testimonials_2_quote"),
        author: {
          userId: "Daniyar T.",
          name: "Daniyar T.",
      ...
      {
        quote: t("frontend:home.testimonials_3_quote"),
        author: {
          userId: "Aida S.",
          name: "Aida S.",
      ...
      {
        quote: t("frontend:home.testimonials_4_quote"),
        author: {
          userId: "Nurlan B.",
          name: "Nurlan B.",
      ...
      {
        quote: t("frontend:home.testimonials_5_quote"),
        author: {
          userId: "Zhanel M.",
          name: "Zhanel M.",
      ...
      <div className="container mx-auto px-4">
        <ScrollAnimation variant="fadeUp" className="text-center mb-16">
          <h2 className="text-4xl font-bold text-foreground mb-4">
            {t("frontend:home.testimonials_title")}
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            {t("frontend:home.testimonials_subtitle")}
          </p>
        </ScrollAnimation>
