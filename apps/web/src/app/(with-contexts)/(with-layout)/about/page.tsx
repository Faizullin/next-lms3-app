...
export default function Page() {
  ...
  const timelineItems = [
    {
      year: t("frontend:about.timeline_team_formation_year"),
      title: t("frontend:about.timeline_team_formation_title"),  
      description: t("frontend:about.timeline_team_formation_desc"),
      image:
    ...
    {
      year: t("frontend:about.timeline_nuris_year"),
      title: t("frontend:about.timeline_nuris_title"),
      description: t("frontend:about.timeline_nuris_desc"), 
      image:
    ...
    {
      year: t("frontend:about.timeline_partnerships_year"),
      title: t("frontend:about.timeline_partnerships_title"),
      description: t("frontend:about.timeline_partnerships_desc"),
      image:
    ...
    {
      year: t("frontend:about.timeline_scaling_year"),
      title: t("frontend:about.timeline_scaling_title"),
      description: t("frontend:about.timeline_scaling_desc"),
      image:
    ...
    {
      year: t("frontend:about.timeline_future_year"),
      title: t("frontend:about.timeline_future_title"),
      description: t("frontend:about.timeline_future_desc"),
      image:
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-8">
              <Trans
                i18nKey="frontend:about.hero_title"
                t={t}
                components={{
            ...
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6 max-w-4xl mx-auto">
              {t("frontend:about.hero_subtitle")}
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
              {t("frontend:about.history_title")}
            </h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              {t("frontend:about.history_subtitle")}
            </p>
          </ScrollAnimation>
              ...
              <div className="space-y-8 md:space-y-16 relative">
                {timelineItems.map((item, index) => (
                  ...
                  >
                    {/* Timeline Dot */}
                    <div
                      className={`timeline-dot hidden md:block absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full border-4 border-white shadow-lg z-10 transition-all duration-700 ${visibleItems.has(index) ? "opacity-100 scale-100" : "opacity-0 scale-50"} ${item.colorClass}`}
                    />
          ...
          >
            <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center space-x-3 mb-4 md:mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
                  {t("frontend:about.mission_title")}
                </h2>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-base md:text-lg leading-relaxed">
                {t("frontend:about.mission_desc")}
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center space-x-3 mb-4 md:mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
                  {t("frontend:about.vision_title")}
                </h2>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-base md:text-lg leading-relaxed">
                {t("frontend:about.vision_desc")}
              </p>
            </div>
          </ScrollGroup>
        </div>
