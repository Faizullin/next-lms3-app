      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle>{t("auth.signup.card_title")}</CardTitle>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                {validationErrors.name && (
                  <p className="text-sm text-destructive">{t(validationErrors.name)}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {validationErrors.email && (
                  <p className="text-sm text-destructive">{t(validationErrors.email)}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {validationErrors.password && (
                  <p className="text-sm text-destructive">{t(validationErrors.password)}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {validationErrors.confirmPassword && (
                  <p className="text-sm text-destructive">{t(validationErrors.confirmPassword)}</p>
                )}
              </div>
