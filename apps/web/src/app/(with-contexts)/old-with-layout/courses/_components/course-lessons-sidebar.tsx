              ...
              {course.groups?.map((group) => (
                <div key={group.groupId}>
                  <button
                    ...
                    className="w-full p-4 text-left hover:bg-muted/50 transition-colors flex items-center justify-between group border-b border-border"
                  >
                    <div className="flex items-center gap-3">
                        ...
                        return (
                          ...
                          >
                            <Link
                              ...
                              scroll={false}
                              className={`block p-3 pl-6 text-left hover:bg-muted/50 transition-colors border-l-2 hover:border-primary ${
                                isCurrentLesson
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div className="flex-shrink-0 w-6 h-6 rounded-sm border-2 border-border flex items-center justify-center bg-background">
