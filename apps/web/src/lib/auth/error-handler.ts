...
export const getFirebaseErrorMessage = (errorCode: string): AuthError => {
  const errorMap: Record<string, AuthError> = {
    "auth/invalid-email": {
      ...
      userMessage: "auth:errors.invalid_email",
    },
    "auth/user-not-found": {
      code: "auth/user-not-found",
      message: "There is no user record corresponding to this identifier.",
      userMessage: "auth:errors.user_not_found",
    },
    "auth/wrong-password": {
      code: "auth/wrong-password",
      message: "The password is invalid or the user does not have a password.",
      userMessage: "auth:errors.wrong_password",
    },
    "auth/invalid-credential": {
      code: "auth/invalid-credential",
      message: "The credential is invalid or has expired.",
      userMessage: "auth:errors.invalid_credential",
    },
    "auth/email-already-in-use": {
      code: "auth/email-already-in-use",
      message: "The email address is already in use by another account.",
      userMessage: "auth:errors.email_already_in_use",
    },
    "auth/weak-password": {
      code: "auth/weak-password",
      message: "The password is too weak.",
      userMessage: "auth:errors.weak_password",
    },
    "auth/too-many-requests": {
      code: "auth/too-many-requests",
      message: "Too many requests. Try again later.",
      userMessage: "auth:errors.too_many_requests",
    },
    "auth/network-request-failed": {
      code: "auth/network-request-failed",
      message: "Network error. Please check your connection.",
      userMessage: "auth:errors.network_error",
    },
    "auth/popup-blocked": {
      code: "auth/popup-blocked",
      message: "Sign-in popup was blocked by the browser.",
      userMessage: "auth:errors.popup_blocked",
    },
  };
  ...
  return (
    errorMap[errorCode] || {
      ...
      userMessage: "auth:errors.unknown",
    }
  );
};
