...
export function CourseCard({ course, className, viewMode = "grid" }: CourseCardProps) {
    ...
    if (viewMode === "list") {
        return (
            <CourseCardContent.Card className={className}>
                        ...
                        <div className="flex items-center gap-4 text-sm mt-2">
                            ...
                            <div className="flex items-center text-muted-foreground">
                                <span>
                                    ...
                                    {t("dashboard:card.enrollments_count", { count: course.statsEnrollmentCount })}
                                </span>
                            </div>
                        </div>
...
export const CourseCardContent = {
    Card: ({
        ...
        return (
            <Card className={cn("py-0 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1", className)}>
                {children}
            </Card>
        );
    },
