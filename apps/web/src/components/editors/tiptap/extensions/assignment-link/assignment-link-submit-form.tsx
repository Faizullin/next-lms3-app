    ...
    const handleRemoveFile = async (index: number) => {
      ...
      try {
        ...
        if (result.success) {
          ...
          toast({
            title: t("common:success"),
            description: t("common:toast.item_removed_successfully", { item: t("common:file") }),
          });
        }
      } catch (error) {
        toast({
          title: t("common:error"),
          description: t("common:toast.item_remove_error", { item: t("common:file") }),
          variant: "destructive",
        });
      }
    };
            ...
            {submission.score !== undefined && submission.score !== null && (
              <div className="border-t pt-4">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-semibold">{t("common:grade")}</h4>
                ...
                {submission.feedback && (
                  <div>
                    <h4 className="font-semibold mb-2 text-sm">{t("common:feedback")}</h4>
