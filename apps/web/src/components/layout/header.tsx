          ...
          <Branding
            ...
            icon={
              <Image
                ...
                alt={siteInfo?.logo?.caption || siteInfo?.title || t("common:logo")}
                width={40}
                height={40}
        ...
        >
          <div className="flex flex-col space-y-2 py-4">
            ...
            <div className="flex items-center justify-between py-2 px-2">
              <span className="text-gray-700 dark:text-gray-200 font-medium">{t("frontend:nav.theme")}</span>
              <ThemeToggle />
            </div>
