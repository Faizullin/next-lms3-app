...
$env:DOCKER_IMAGE_NAME="uyren-courselit-my" 
...
# Inline command
$env:DOCKER_USERNAME="faizullin";$env:DOCKER_IMAGE_NAME="uyren-courselit-my";docker compose -f docker-compose.prod-manual.yml --env-file .env.prod-manual build web;docker compose -f docker-compose.prod-manual.yml --env-file .env.prod-manual push web
```
...
export DOCKER_IMAGE_NAME=uyren-courselit-my
